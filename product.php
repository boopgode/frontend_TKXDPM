    ...
    <div class="wrapper">
        ...
        <header class="header-area sticky-header">
            <div class="container">
                <div class="row align-items-center">
                  ...
                  <span class="number-product-count">
                    0
                  </span>
                </span>
                            </button>
                ...
                <div class="container">
                    <div class="row mb-n4 mb-sm-n10 g-3 g-sm-6">
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=1">Readable content DX22</a></h4>
                                    <div class="prices">
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=2">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=2">Modern Eye Brush</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=3">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=3">Voyage face cleaner</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=4">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=4">Impulse Duffle</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=5">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=5">Sprite Yoga Straps1</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=6">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=6">Fusion facial cream</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=7">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=7">Readable content DX22</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=8">
                                        <img src="assets/images/shop/6.webp" width="370" height="450" alt="Image-HasTech">
                                    </a>
                                    <span class="flag-new">new</span>
                                    <div class="product-action">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=8">Voyage face cleaner</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
                        ...
                        <div class="col-6 col-lg-4 mb-4 mb-sm-8">
                            ...
                            <div class="product-item">
                                <div class="product-thumb">
                                    <a class="d-block" href="product-details.php?id=9">
                                ...
                                <div class="product-info">
                                    ...
                                    <h4 class="title"><a href="product-details.php?id=9">Modern Eye Brush</a></h4>
                                    <div class="prices">
                                        <span class="price">$210.00</span>
                                        <span class="price-old">300.00</span>
                                    </div>
            ...
            <div class="footer-bottom">
                <div class="container pt-0 pb-0">
                    <div class="footer-bottom-content">
                        <p class="copyright">© 2022 Brancy. Made with <i class="fa fa-heart"></i> by <a target="_blank" href="">Me</a></p>
                    </div>
                </div>
            </div>
            <!--== End Footer Bottom ==-->
        ...
        <aside class="aside-cart-wrapper offcanvas offcanvas-end" tabindex="-1" id="AsideOffcanvasCart" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body">
                ...
                <p class="cart-total"><span>Subtotal:</span><span class="amount">$0</span></p>
