...
<html class="no-js" lang="zxx">
    <head>
        ...
        <meta
            name="description"
            content="Brancy - Cosmetic & Beauty Salon Website Template"
        />
        <meta
            name="viewport"
        ...
        />
        <link
            href="../../css2?family=Inter:wght@300;400;500;600;700&display=swap"
            rel="stylesheet"
        />
    ...
    <body>
        ...
        <div class="wrapper">
                        ...
                        <div class="col-lg-6 d-none d-lg-block">
                            <div class="header-navigation">
                                <ul class="main-nav justify-content-start">
                                    ...
                                    <li class="has-submenu">
                                        <a href="account-login.php">Pages</a>
                ...
                >
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <div
                                class="page-header-st3-content text-center text-md-start"
                                >
                                <ol
                                class="breadcrumb justify-content-center justify-content-md-start"
                                >
                                ...
                                <div class="my-account-item-wrap">
                                    ...
                                    <div class="my-account-form">
                                        <form action="#" method="post">
                                            ...
                                            <div
                                                class="form-group d-flex align-items-center mb-14"
                                            >
                                                <input
                                                type="submit"
                                                name="login"
                                        ...
                                        if(isset($_POST["login"]))
                                        {
                                            include("control.php");
                                            $get_data = new data();
                                            if(empty($_POST["login_username"])||empty($_POST["login_pw"]))
                                            {
                                                echo ("<script>alert ('không được để trống')</script>");
                                            }
                                            else
                                            {
                                                $login = $get_data->login($_POST["login_username"], $_POST["login_pw"]);
                                                if($login==1)
                                                {
                                                    $_SESSION["user"]=$_POST["login_username"];
                                                    $_SESSION["pass"]=$_POST["login_pw"];
                                                    $get_level=$get_data->get_level($_SESSION["user"]);
                                                    foreach($get_level as $select){
                                                        $level=$select["level"];
                                    ...
                                    <div class="my-account-form">
                                        <form action="#" method="post">
                                            ...
                                            <div class="form-group mb-6">
                                                ...
                                                <input type="text" name="register_fname">
                                            </div>
                                            <div class="form-group mb-6">
                                                <label for="">Last Name <sup>*</sup></label>
                                                <input type="text" name="register_lname">
                                            </div>
                                            <div class="form-group mb-6">
                                        ...
                                        {   
                                            include("control.php");
                                            $get_data=new data();
                                            if(empty($_POST["register_username"])||empty($_POST["register_pw"])||empty($_POST["register_repw"]))
                                                {
                                                echo("<script>alert('Không được để trống');</script>");
                                                }
                                            else
                                            {
                                                ...
                                                $check_account=$get_data->check_account($_POST["register_username"]);
                                                $level=2;
                                                if($check_account>0)
                                                {
                                                    echo("<script>alert('Account đã tồn tại');</script>");
                                                }
                                                else
                                                {
                                                    if($_POST["register_pw"]!=$_POST["register_repw"])
                                                    {
                                                        echo("<script>alert('Password và Re Password Phải giống nhau');</script>");
                                                    }
                                                    else
                                                    {
                                                        $register = $get_data->register($_POST["register_username"],$_POST["register_fname"],$_POST["register_lname"],$_POST["register_address"],$_POST["register_Phone"],$_POST["register_pw"],$level);
                                                        if($register)
                                                        {
                        ...
                        <div class="modal-body">
                            <div class="product-action-view-content">
                                ...
                                <div class="modal-action-messages">
                                    <i class="fa fa-check-square-o"></i> Added
                ...
                <div class="offcanvas-body">
                    <div class="container pt--0 pb--0">
                        <div class="search-box-form-wrap">
                            ...
                            <form action="#" method="post">
                                <div
                                    class="aside-search-form position-relative"
                                >
                                    <label
                                        for="SearchInput"
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            >
                                                <h5
                                                    class="product-details-collection"
                                                >
                                                    Premioum collection
                                                </h5>
                                                <h3
                                                ...
                                                >
                                                    Offbline Instant Age Rewind
                                                    Eraser.
                                                </h3>
                                                <div
                                                    class="product-details-review mb-5"
                                                >
                                                    <div
                                                        class="product-review-icon"
                                                    >
                                                        <i
                                                            class="fa fa-star-o"
                                                        ></i>
                                                ...
                                                <p class="mb-6">
                                                    ...
                                                    Nam voluptate illo ut quia
                                                    non sapiente provident alias
                                                    quos laborum incidunt, earum
                                                    accusamus, natus. Vero
                                                    pariatur ut veniam sequi
                                                    amet consectetur.
                                                </p>
                                                <div
                                                    class="product-details-pro-qty"
                                                >
                                                    <div class="pro-qty">
                                                        <input
                                                            type="text"
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="product-details-cart-wishlist"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="btn"
            ...
            >
                <div class="offcanvas-header">
                    <h1 class="d-none" id="offcanvasRightLabel">
                        Shopping Cart
                    </h1>
                    <button
                ...
                <div class="offcanvas-body">
                    ...
                    <a class="btn-total" href="product-checkout.php"
                        >Checkout</a
                    >
                </div>
            </aside>
            ...
            >
                <div class="offcanvas-header">
                    <h1 class="d-none" id="offcanvasExampleLabel">
                        Aside Menu
                    </h1>
                    <button
                ...
                <div class="offcanvas-body">
                    <div id="offcanvasNav" class="offcanvas-menu-nav">
                        <ul>
                            ...
                            <li class="offcanvas-nav-parent">
                                <a class="offcanvas-nav-item" href="#">shop</a>
                                <ul>
                                    <li>
                                        <a href="#" class="offcanvas-nav-item"
                                            >Shop Layout</a
                                        >
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <a
                                                    href="product-four-columns.php"
                                                    >Shop 4 Column</a
                                                >
                                            </li>
                                            <li>
                                                <a
                                                    href="product-left-sidebar.php"
                                                    >Shop Left Sidebar</a
                                                >
                                            </li>
                                            <li>
                                                <a
                                                    href="product-right-sidebar.php"
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a
                                                    href="product-details-normal.php"
                                            ...
                                            <li>
                                                <a
                                                    href="product-details-group.php"
                                                    >Single Product Group</a
                                                >
                                            </li>
                                            <li>
                                                <a
                                                    href="product-details-affiliate.php"
                            ...
                            <li class="offcanvas-nav-parent">
                                <a class="offcanvas-nav-item" href="#">Blog</a>
                                <ul>
                                    <li>
                                        <a class="offcanvas-nav-item" href="#"
                                            >Blog Layout</a
                                        >
                                        <ul>
                                            <li>
                            ...
                            <li class="offcanvas-nav-parent">
                                <a class="offcanvas-nav-item" href="#">Pages</a>
                                <ul>
                                    <li>
                                        <a href="account-login.php"
                                            >My Account</a
